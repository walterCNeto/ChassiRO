...
A landing aponta para a API hospedada em `https://chassiro-api.fly.dev`. Quando ela
estiver dormindo (auto-stop após inatividade), a primeira chamada pode levar 1-3
segundos para acordar. Depois, latência fica em milissegundos.
